                        ...
                        <RB.Panel>
                            ...
                            <RB.Row>
                                <RB.Col xs={12}>
                                    ...
                                    <p className="text-center lead">{currDisplayNumber} <small>({currDisplayOffset}) - {offsetNames[currDisplayOffset]}</small></p>
                                </RB.Col>
                            </RB.Row>
                            <RB.Row>
                                <RB.Col xs={12} sm={2} smOffset={4}>                                
                                    <RB.Well onClick={this.incrementCount} bsSize="sm">
                                        <p  style={styles}><Icon  name="plus" size="4x" /></p>
                                    </RB.Well>
                                </RB.Col>
                                <RB.Col xs={12} sm={2} smPush={1}>
                                    <RB.Well onClick={this.decrementCount} bsSize="sm">
                                        <p  style={styles}><Icon name="minus" size="4x" /></p>
                                    </RB.Well>
                                </RB.Col>
                            </RB.Row>                            
                        </RB.Panel>
